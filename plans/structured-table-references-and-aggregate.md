...
| 9 | Excel's date serial epoch (serial 1 = 1900-01-01, phantom 1900-02-29 at 60) — **executes after Phase 8** (added 2026-09-09 under the P0 addendum) | [`phase-9-date-epoch.md`](structured-table-references-and-aggregate/phase-9-date-epoch.md) | — | — | — | **In final review** — `feat/date-epoch`, `f0fbb4a..92eae6a` (21 commits, 6 tasks); core 1536/0, Excel 93/0; the user's 1900 working-day exception is implemented and bounded |
