...
| 9 | Excel's date serial epoch (serial 1 = 1900-01-01, phantom 1900-02-29 at 60) — **executes after Phase 8** (added 2026-09-09 under the P0 addendum) | [`phase-9-date-epoch.md`](structured-table-references-and-aggregate/phase-9-date-epoch.md) | — | — | — | Design in progress |
...
| 11 | Excel-compatibility sweep of the recorded divergences (nested-AGGREGATE skip → count as Aspose does, scalar in a `ref` slot, `MODE.SNGL` tie-break, single error cell under option 6, defined-name mini-CSE gap, `SUBTOTAL(9,IF(TRUE,A1:A3,B1:B3))`) — **executes after Phase 10, before Phase 3** (added 2026-09-09) | [`phase-11-excel-compatibility-sweep.md`](structured-table-references-and-aggregate/phase-11-excel-compatibility-sweep.md) | — | — | — | Design in progress |
