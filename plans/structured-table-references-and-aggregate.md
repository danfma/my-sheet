...
| 11a | Unblocking slice of the sweep — the defined-name mini-CSE gap (item 8 + correction B2) and the criteria family's silent answers over a computed argument (item 22) — **executed after Phase 10 and before Phase 7** (added 2026-09-10; the original note also said "before Phase 3", which Phase 3's completion has made unsatisfiable — 11a in fact landed after it) | [`phase-11a-unblocking-slice.md`](structured-table-references-and-aggregate/phase-11a-unblocking-slice.md) | 9 | — | — | **Complete** — `feat/unblocking-slice`, `4c083da..HEAD`; core 1634 / 0, Excel 93 / 0; a name in an array position is now what it is bound to, a computed array in a criteria range slot is `#REF!`, four expectations flipped, four measured divergences handed to Phase 11 |
