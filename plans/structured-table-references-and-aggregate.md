...
| 11a | Unblocking slice of the sweep — the defined-name mini-CSE gap (item 8 + correction B2) and the criteria family's silent answers over a computed argument (item 22) — **executes after Phase 10, before Phase 3 and Phase 7** (added 2026-09-10) | [`phase-11a-unblocking-slice.md`](structured-table-references-and-aggregate/phase-11a-unblocking-slice.md) | 9 | — | — | **Complete** — `feat/unblocking-slice`, `4c083da..HEAD`; core 1634 / 0, Excel 93 / 0; a name in an array position is now what it is bound to, a computed array in a criteria range slot is `#REF!`, four expectations flipped, four measured divergences handed to Phase 11 |
| 11 | Excel-compatibility sweep of the recorded divergences (nested-AGGREGATE skip → count as Aspose does, scalar in a `ref` slot, `MODE.SNGL` tie-break, single error cell under option 6, defined-name mini-CSE gap, `SUBTOTAL(9,IF(TRUE,A1:A3,B1:B3))`) — **executes after Phase 10, before Phase 3** (added 2026-09-09) | [`phase-11-excel-compatibility-sweep.md`](structured-table-references-and-aggregate/phase-11-excel-compatibility-sweep.md) | — | — | — | Not started — design verified 2026-09-09 (2 blockers, 7 majors, 14 minors folded in) and grown to 20 items, 8 of them measured during Phases 8 and 9 |
