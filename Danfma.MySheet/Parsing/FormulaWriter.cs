...
public static class FormulaWriter
{
    ...
    public static string ToFormula(this Expression expression, string contextSheetName)
    {
        ...
        Write(builder, expression, contextSheetName, minPrecedence: 0, depth: 0, deltaRow: 0, deltaColumn: 0);
    ...
    )
    {
        ...
        switch (expression)
        {
            ...
            case DynamicRange dyn:
                Write(builder, dyn.Start, context, AtomPrecedence, depth + 1, deltaRow, deltaColumn);
                builder.Append(':');
            ...
            case UnaryOperation { Operator: UnaryOperator.Percent } percent:
                Write(builder, percent.Operand, context, PercentPrecedence, depth + 1, deltaRow, deltaColumn);
                builder.Append('%');
                break;

            case UnaryOperation prefix:
                builder.Append(prefix.Operator == UnaryOperator.Negate ? '-' : '+');
                Write(builder, prefix.Operand, context, PrefixPrecedence, depth + 1, deltaRow, deltaColumn);
                break;
            ...
            case AnchoredCellReference anchoredCell:
                ...
                builder.Append(
                    new CellAddress(
                        anchoredCell.ColumnAbsolute ? anchoredCell.Column : anchoredCell.Column + deltaColumn,
            ...
            case SharedFormulaSlave slave:
                ...
                Write(builder, slave.Master, context, 0, depth + 1, slave.DeltaRow, slave.DeltaColumn);
                break;
