...
// or previously serialized data (and the WorkbookTests round-trip) will break. Add new tags at 328+
...
// Structured table references (Tabela1[Valor], Tabela1[#All], ...): one node for every shape, so one tag.
