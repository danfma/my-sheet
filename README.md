...
And to be equally honest about scope: MySheet implements **254 built-in functions** (plus your own custom
...
| --- | --- |
| [`Danfma.MySheet`](https://www.nuget.org/packages/Danfma.MySheet/) | The core engine: formula parser, 254 built-in functions, custom functions, allocation-free evaluation, per-cell memoization, MemoryPack serialization. |
...
- **254 built-in functions**: logical (`IF/IFS/SWITCH/AND/OR/XOR/NOT/IFERROR/IFNA/LET/TRUE/FALSE`),
...
| [Function reference](docs/function-reference.md) | All 254 built-in functions by category, plus the full Excel coverage table. |
...
MySheet implements 254 of the ~520 functions in Microsoft's official Excel function catalog. The full
