...
public class LookupFunctionTests
{
    ...
    {
        await Assert.That(Calc("=MATCH(20,A1:A3,0)", ("A1", 10), ("A2", 20), ("A3", 30)) as double?)
            .IsEqualTo(2.0);
        await Assert.That(Calc("=MATCH(99,A1:A3,0)", ("A1", 10), ("A2", 20), ("A3", 30)))
    ...
    public async Task Match_ApproximateAscending()
    {
        ...
        await Assert.That(Calc("=MATCH(25,A1:A3,1)", ("A1", 10), ("A2", 20), ("A3", 30)) as double?)
            .IsEqualTo(2.0);
    }
    ...
    {
        await Assert.That(Calc("=INDEX(A1:A3,2)", ("A1", 10), ("A2", 20), ("A3", 30)) as double?)
            .IsEqualTo(20.0);
    }
    ...
    {
        await Assert.That(Calc("=INDEX(A1:C1,2)", ("A1", 7), ("B1", 8), ("C1", 9)) as double?)
            .IsEqualTo(8.0);
    }
    ...
    {
        await Assert.That(Calc("=INDEX(A1:B2,2,2)", ("A1", 1), ("B1", 2), ("A2", 3), ("B2", 4)) as double?)
            .IsEqualTo(4.0);
    }
}
