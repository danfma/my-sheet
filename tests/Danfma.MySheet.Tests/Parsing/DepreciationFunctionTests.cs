...
public class DepreciationFunctionTests
{
    ...
    {
        await Assert
            .That(Num(Calc("=SLN(30000,7500,10)")))
            .IsEqualTo(Financial.Sln(30000, 7500, 10))
            .Within(Tolerance);
    }
    ...
    {
        await Assert
            .That(Num(Calc("=SYD(30000,7500,10,1)")))
            .IsEqualTo(Financial.Syd(30000, 7500, 10, 1))
            .Within(Tolerance);
        await Assert
            .That(Num(Calc("=SYD(30000,7500,10,10)")))
            .IsEqualTo(Financial.Syd(30000, 7500, 10, 10))
            .Within(Tolerance);
    }
    ...
    public async Task Db_MatchesExcel()
    {
        ...
        await Assert
            .That(Num(Calc("=DB(1000000,100000,6,1,7)")))
            .IsEqualTo(Financial.Db(1000000, 100000, 6, 1, 7))
            .Within(Tolerance);
        await Assert
            .That(Num(Calc("=DB(1000000,100000,6,2,7)")))
            .IsEqualTo(Financial.Db(1000000, 100000, 6, 2, 7))
            .Within(Tolerance);
        // month defaults to 12 when omitted.
        await Assert
            .That(Num(Calc("=DB(1000000,100000,6,2)")))
            .IsEqualTo(Financial.Db(1000000, 100000, 6, 2, 12))
            .Within(Tolerance);
    }
    ...
    {
        await Assert
            .That(Num(Calc("=DDB(2400,300,10,1)")))
            .IsEqualTo(Financial.Ddb(2400, 300, 10, 1, 2))
            .Within(Tolerance);
        await Assert
            .That(Num(Calc("=DDB(2400,300,10,5,1.5)")))
            .IsEqualTo(Financial.Ddb(2400, 300, 10, 5, 1.5))
            .Within(Tolerance);
    }
    ...
    {
        await Assert
            .That(Num(Calc("=VDB(2400,300,3650,0,1)")))
            .IsEqualTo(Financial.Vdb(2400, 300, 3650, 0, 1))
            .Within(Tolerance);
        await Assert
            .That(Num(Calc("=VDB(2400,300,10,0,0.875,1.5)")))
            .IsEqualTo(Financial.Vdb(2400, 300, 10, 0, 0.875, 1.5))
            .Within(Tolerance);
        // no_switch = TRUE keeps declining balance.
        await Assert
            .That(Num(Calc("=VDB(2400,300,10,6,10,2,TRUE)")))
    ...
    public async Task AmorLinc_MatchesExcel()
    {
        ...
        var expected = Financial.AmorLinc(
            2400,
            new DateTime(2008, 8, 19),
        ...
        await Assert
            .That(Num(Calc("=AMORLINC(2400,DATE(2008,8,19),DATE(2008,12,31),300,1,0.15,1)")))
            .IsEqualTo(expected)
            .Within(Tolerance);
    }
    ...
    public async Task AmorLinc_FirstPeriod_MatchesExcel()
    {
        ...
        await Assert
            .That(Num(Calc("=AMORLINC(2400,DATE(2008,8,19),DATE(2008,12,31),300,0,0.15,1)")))
            .IsEqualTo(expected)
            .Within(Tolerance);
    }
    ...
    {
        await Assert
            .That(Calc("=AMORLINC(2400,DATE(2008,8,19),DATE(2008,12,31),300,1,0.15,2)"))
    ...
    {
        var expected = Financial.AmorDegrc(
            2400,
            new DateTime(2008, 8, 19),
            new DateTime(2008, 12, 31),
            300,
        ...
        await Assert
            .That(Num(Calc("=AMORDEGRC(2400,DATE(2008,8,19),DATE(2008,12,31),300,1,0.15,1)")))
            .IsEqualTo(expected)
            .Within(Tolerance);
    }
        ...
        for (var period = 0; period <= 5; period++)
        {
            ...
            await Assert
                .That(
                    Num(
                        Calc(
                            $"=AMORDEGRC(2400,DATE(2008,8,19),DATE(2008,12,31),300,{period},0.15,1)"
                        )
                    )
                )
                .IsEqualTo(expected)
